...
import cn.wenwuyun.modules.preview.config.DocProperties;
...
public class ZipUtils {
    private static DocProperties docProperties = SpringContextHolder.getBean(DocProperties.class);
    ...
    public static void reCodeFilesUrl_link(File file) throws IOException {
        ...
        }
        {
            ...
            for (Element node : doc.getElementsByTag("title")) {
                ...
                str.append(docProperties.getWebTitle());
