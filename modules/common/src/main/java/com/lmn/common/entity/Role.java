...
public class Role extends DataEntity<Role> {
    ...
    private List<Menu> userMenuList = Lists.newArrayList(); // 当前用户拥有权限的菜单列表
    private List<Office> userOfficeList = Lists.newArrayList(); // 当前用户拥有权限的机构列表
...
//	}
    ...
    public List<Office> getUserOfficeList() {
        return userOfficeList;
    }

    public void setUserOfficeList(List<Office> userOfficeList) {
