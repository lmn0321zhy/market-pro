package com.lmn.common.security.shiro.session;
...
public class CacheSessionDAO extends EnterpriseCacheSessionDAO implements SessionDAO {
    ...
    protected void doUpdate(Session session) {
        ...
        if (request != null) {
            ...
            // 如果是视图文件，则不更新SESSION
            if (StringUtils.startsWith(uri, Const.getConfig("web.view.prefix"))
                    && StringUtils.endsWith(uri, Const.getConfig("web.view.suffix"))) {
                return;
            }
            // 手动控制不更新SESSION
